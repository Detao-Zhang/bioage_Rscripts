...
male_results <- cbind(name, k, q, s, r)
#row.names(male_results)[1] <- "ECG.P.R_interval_male"
write(male_results, file = "./kidney_ageParameter.txt", append = TRUE, sep="\t", ncolumns=5)
...
write(female_results, file = "./kidney_ageParameter.txt", append = TRUE, sep="\t", ncolumns=5)
...
male_results <- cbind(name, k, q, s, r)
#row.names(male_results)[1] <- "ECG.P.R_interval_male"
write(male_results, file = "./liver_ageParameter.txt", append = TRUE, sep="\t", ncolumns=5)
...
write(female_results, file = "./liver_ageParameter.txt", append = TRUE, sep="\t", ncolumns=5)
...
male_results <- cbind(name, k, q, s, r)
#row.names(male_results)[1] <- "ECG.P.R_interval_male"
write(male_results, file = "./nutrition_ageParameter.txt", append = TRUE, sep="\t", ncolumns=5)
...
write(female_results, file = "./nutrition_ageParameter.txt", append = TRUE, sep="\t", ncolumns=5)
...
male_results <- cbind(name, k, q, s, r)
#row.names(male_results)[1] <- "ECG.P.R_interval_male"
write(male_results, file = "./hormone_ageParameter.txt", append = TRUE, sep="\t", ncolumns=5)
...
write(female_results, file = "./hormone_ageParameter.txt", append = TRUE, sep="\t", ncolumns=5)
...
male_results <- cbind(name, k, q, s, r)
#row.names(male_results)[1] <- "ECG.P.R_interval_male"
write(male_results, file = "./skin_ageParameter.txt", append = TRUE, sep="\t", ncolumns=6)
...
write(female_results, file = "./skin_ageParameter.txt", append = TRUE, sep="\t", ncolumns=6)
...
male_results <- cbind(name, k, q, s, r)
#row.names(male_results)[1] <- "ECG.P.R_interval_male"
write(male_results, file = "./sport_bodycomParameter.txt", append = TRUE, sep="\t", ncolumns=5)
...
write(female_results, file = "./sport_bodycomParameter.txt", append = TRUE, sep="\t", ncolumns=5)
...
male_results <- cbind(name, k, q, s, r)
#row.names(male_results)[1] <- "ECG.P.R_interval_male"
write(male_results, file = "./Gut_meta_Parameter.txt", append = TRUE, sep="\t", ncolumns=5)
...
write(female_results, file = "./Gut_meta_Parameter.txt", append = TRUE, sep="\t", ncolumns=5)
}
